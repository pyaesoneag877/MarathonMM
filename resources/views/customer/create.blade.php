...
<div class="container col-7">
        <div class="row">
            ...
            <h3 class="text-primary my-3">Create New Customer</h3>
            ...
            <div class="mb-3">
                ...
                <input type="tel" name="phone_no" value="{{old('phone_no')}}" class="form-control" id="exampleInputPhone" aria-describedby="phoneHelp">
            </div>
